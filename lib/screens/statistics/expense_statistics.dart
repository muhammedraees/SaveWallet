...
class ExpenseStatistics extends StatefulWidget {
  const ExpenseStatistics({Key? key}) : super(key: key);
        ...
        Expanded(
          child: ValueListenableBuilder<List<TransactionModel>>(
            ...
            builder: (BuildContext context, List<TransactionModel> newList, _) {
              List<TransactionModel> expenseTransactions = newList
              ...
              if (dataMap.isEmpty) {
                return const Center(
                    child: Text('Expense statistics is Empty',
              ...
              return Padding(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Total Expense: ${getFilteredTotal(expenseTransactions)}',
